...
function config($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        pain: {
            ...
            activity: 'Activity',
            cry: 'Crying',
            comfort: 'Trøstbarhed_XX',
            faceExpression0: 'Upåvirket/Afslappet_XX',
            ...
            activity2: '"Går i bro", stiv eller kaster sig rundt_XX',
            cry0: 'Græder ikke (Vågen eller sovende)',
            cry1: 'Klynker, klager sig af og til_XX',
            cry2: 'Græder uafbrudt, skriger eller klager sig hyppigt',
            comfort0: 'Tilfreds, afslappet_XX',
            ...
            smiley0: 'Man kan gøre fuldstændig, som man plejer uden at tænke på, at det gør ondt._XX',
            smiley2: 'Man kan gøre, som man plejer, men af og til må man standse op, fordi det gør ondt._XX',
            smiley4: 'Man har mest lyst til at sidde stille og få læst en historie eller se fjernsyn, fordi det gør ondt._XX',
            smiley6: 'Man tænker på, at det gør ondt hele tiden._XX',
            smiley8: 'Man har så ondt, at man har lyst til at græde, fordi det gør ondt._XX',
            smiley10: 'Man har så ondt, at man slet ikke kan holde det ud._XX',
        ...
        mucositis: {
            ...
            //question 1
            painQ0: 'Ingen_XX',
            painQ1: 'Let smerte_XX',
            painQ2: 'Moderat smerte_XX',
            painQ3: 'Kraftige smerter med behov for morfin_XX',
            painQ4: 'Kraftige smerter og behov for store mængder morfin_XX',
            soresAndRedness: 'Sår og rødme_XX',
            soresQ0: 'Ingen_XX',
            soresQ1: 'Rødme (ingen sår)_XX',
            soresQ2: 'Enkelte eller flere mindre sår_XX',
            soresQ3: 'Udtalt rødme, store eller mange sår_XX',
            soresQ4: 'Størstedelen af munden er påvirket af rødme eller sår_XX',
            foodIntakeInfluence: 'Påvirkning af fødeindtag_XX',
            foodIntakeQ0: 'Ingen_XX',
            foodIntakeQ1: 'Spiser næsten normalt_XX',
            foodIntakeQ2: 'Spiser enkelte typer af fast føde_XX',
            foodIntakeQ3: 'Drikker og spiser flydende_XX',
            foodIntakeQ4: 'Drikker minimalt og har behov for iv, væske, sondemad eller TPN_XX',

            //frontside
            pain: 'Pain',
            soresRedness: 'Sores/Redness',
            foodIntake: 'Food intake',
            pain0: 'Ingen smerter_XX', // TODO translate ↓
            pain1: 'Lette smerter_XX',
            pain2: 'Moderate smerter_XX',
            pain3: 'Kraftige smerter_XX',
            pain4: 'Uudholdlige smerter_XX',
            sores0: 'Ingen sår_XX',
            sores1: 'Ingen sår, let rødmen_XX',
            sores2: 'Enkelte mindre sår_XX',
            sores3: 'Mange sår_XX',
            sores4: 'Udtalt rødmen + mange store sår_XX',
            foodIntake0: 'Ingen påvirkning_XX',
            foodIntake1: 'Spiser næsten normalt_XX',
            foodIntake2: 'Spiser lidt fast føde_XX',
            foodIntake3: 'Spiser flydende føde_XX',
            foodIntake4: 'Behov for sondemad_XX'
        },
